  ...
  return (
    <div className="flex flex-col items-center rounded-lg bg-white bg-opacity-80 bg-clip-padding px-24 py-10 ring-1 ring-gray-900/5 drop-shadow-2xl backdrop-blur-xl">
      ...
      <input
        ...
        className="m-4 text-slate-500 file:mr-4 file:rounded-full file:border-0 file:bg-violet-100 file:py-2 file:px-4 file:font-semibold file:text-violet-700 hover:file:bg-violet-200"
      />
    </div>
  );
}
